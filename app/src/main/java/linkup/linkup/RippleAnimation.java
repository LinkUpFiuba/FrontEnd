...
/**
 * Esta clase se usa para crear el efecto de animación de circulos, Background Ripple Animation
 */
...
public class RippleAnimation extends RelativeLayout {
    ...
    private void init(final Context context, final AttributeSet attrs) {
        ...
        rippleColor = typedArray.getColor(R.styleable.RippleAnimation_rb_color, getResources().getColor(R.color.colorAccent));
